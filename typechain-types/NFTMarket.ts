...
export interface NFTMarketInterface extends utils.Interface {
  functions: {
    ...
    "getItemsCreated()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getItemsCreated",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface NFTMarket extends BaseContract {
  ...
  getItemsCreated(overrides?: CallOverrides): Promise<MarketItemStructOutput[]>;

  getListingPrice(overrides?: CallOverrides): Promise<BigNumber>;

  getMarketItems(overrides?: CallOverrides): Promise<MarketItemStructOutput[]>;
  ...
  estimateGas: {
    ...
    getItemsCreated(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getItemsCreated(overrides?: CallOverrides): Promise<PopulatedTransaction>;
